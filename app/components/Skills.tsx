...
import { Code, Brain, Users, Lightbulb, Zap, Target, Rocket, Star } from 'lucide-react'
...
const Skills = () => {
  ...
  const softSkills = [
    { name: 'Communication', icon: Users, description: 'Clear and effective communication with team members and clients' },
    { name: 'Critical Thinking', icon: Brain, description: 'Analytical approach to problem-solving and decision making' },
    { name: 'Problem Solving', icon: Lightbulb, description: 'Creative solutions to complex technical challenges' },
    { name: 'Leadership', icon: Target, description: 'Leading projects and mentoring junior developers' },
  ]
  ...
  return (
    <section id="skills" className="py-20 bg-gray-50 dark:bg-dark-800 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Skills & <span className="gradient-text dark:gradient-text-dark">Expertise</span>
          </h2>
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  Expert in modern frontend frameworks with focus on user experience
                </p>
              </motion.div>
              ...
              >
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h4 className="font-bold text-gray-900 dark:text-white">Full-Stack</h4>
                </div>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  End-to-end development with database integration and optimization
                </p>
              </motion.div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h4 className="font-bold text-gray-900 dark:text-white text-xl">Professional Approach</h4>
              </div>
