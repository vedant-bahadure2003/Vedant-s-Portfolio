  ...
  const educationData = [
    {
      ...
      current: true,
      description: 'Focusing on modern software development, algorithms, and system design',
      achievements: ['Dean\'s List', 'Programming Club Member', 'Hackathon Participant']
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            My <span className="gradient-text dark:gradient-text-dark">Education</span>
          </h2>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            My educational journey that shaped my foundation in computer science and technology
          </p>
        </motion.div>
        ...
        >
          {educationData.map((edu, index) => (
            <motion.div
              ...
              className={`relative bg-white dark:bg-dark-800 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 p-8 border-l-4 overflow-hidden ${
                edu.current 
                  ...
                  <div className="flex-1">
                    <div className="flex items-start space-x-6">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-8 space-y-3 sm:space-y-0 text-gray-500 dark:text-gray-400 mb-6">
                          <motion.div 
                            whileHover={{ x: 5 }}
                          ...
                          <div className="flex flex-wrap gap-2">
                            {edu.achievements.map((achievement, achievementIndex) => (
                              <motion.span
                                ...
                                className="px-3 py-1 bg-gray-100 dark:bg-dark-700 text-gray-700 dark:text-gray-300 rounded-full text-sm font-medium hover:bg-blue-100 dark:hover:bg-blue-900/30 hover:text-blue-700 dark:hover:text-blue-300 transition-all duration-200"
                              >
                                {achievement}
                              </motion.span>
                            ))}
