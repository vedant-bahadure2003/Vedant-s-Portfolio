...
import { Mail, Phone, MapPin, Send, CheckCircle, MessageCircle, User, AtSign } from 'lucide-react'
    ...
    <section id="contact" className="py-20 bg-gray-50 dark:bg-dark-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed mb-8">
                ...
                or just want to say hello, I'm always excited to connect with fellow developers and potential collaborators.
              </p>
            </motion.div>
              ...
              {contactInfo.map((info, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">{info.label}</p>
                      {info.href === '#' ? (
                        <span className="text-gray-900 dark:text-white font-semibold text-lg">{info.value}</span>
                      ) : (
                        <a
                          href={info.href}
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h4 className="font-bold text-gray-900 dark:text-white text-xl">What I Can Help With</h4>
              </div>
          ...
          >
            <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">Send a Message</h3>
