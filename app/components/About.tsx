...
const About = () => {
  const hobbies = [
    ...
    { icon: Dumbbell, name: 'Fitness Enthusiast', color: 'from-emerald-500 to-teal-500' },
    { icon: Code, name: 'Open Source', color: 'from-purple-500 to-pink-500' },
    { icon: Coffee, name: 'Coffee Lover', color: 'from-amber-500 to-orange-500' },
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              >
                I'm a dedicated Computer Science student with a passion for creating exceptional 
                digital experiences. My journey in web development started with curiosity and has 
                evolved into a deep commitment to building user-centered applications that make a difference.
              </motion.p>
              ...
              >
                Currently working as a Full-Stack Developer Intern at Infusyx Services, where I've 
                contributed to multiple high-impact projects including consultancy platforms, university 
                websites, and corporate web solutions. I specialize in modern web technologies like 
              ...
              >
                ...
                on performance, accessibility, and user experience. I believe in writing clean, 
